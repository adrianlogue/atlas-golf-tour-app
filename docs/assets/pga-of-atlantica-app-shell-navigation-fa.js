...
(function () {
  ...
  const jumpData = [
    ...
    ['Key interactions', [
      ...
      ['Hole-by-hole scorecard', { boot: true, mode: 'fan', tour: 'atlas', tab: 'leaderboards', sheet: { type: 'scorecard', playerId: 'p-csutherland', row: D.leaderboard[0], tournament: D.tournaments.find((t) => t.id === 't-atlpga') } }],
