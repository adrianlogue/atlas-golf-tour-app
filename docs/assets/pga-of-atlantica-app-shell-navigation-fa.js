...
(function () {
  ...
  const jumpData = [
    ['Fans — anonymous', [
      ...
      ['Tournament — rich event page', { boot: true, mode: 'fan', tour: 'atlas', tab: 'schedule', push: { screen: 'tournament', params: { id: 't-atlopen' } } }],
      ['Rankings — Order of Merit', { boot: true, mode: 'fan', tour: 'atlas', tab: 'rankings' }],
      ['Player profile + career history', { boot: true, mode: 'fan', tab: 'home', push: { screen: 'player', params: { id: 'p-csmith' } } }],
      ['More', { boot: true, mode: 'fan', tab: 'more' }],
    ]],
    ['Key interactions', [
      ['Tour switcher', { boot: true, mode: 'fan', tab: 'home', sheet: { type: 'tourSwitcher' } }],
      ['Hole-by-hole scorecard', { boot: true, mode: 'fan', tour: 'atlas', tab: 'leaderboards', sheet: { type: 'scorecard', playerId: 'p-csmith', row: D.leaderboard[0], tournament: D.tournaments.find((t) => t.id === 't-atlpga') } }],
      ['OoM points breakdown', { boot: true, mode: 'fan', tab: 'rankings', sheet: { type: 'oomBreakdown', pid: 'p-csmith' } }],
    ...
    ['Member / Player Portal (Tier 3)', [
      ...
      ['Event hub — player view', { boot: true, mode: 'member', tier: { member: true }, tab: 'portal', push: { screen: 'eventHub', params: { id: 't-atlopen' } } }],
